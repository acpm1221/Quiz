...
function resetTimer() {
    ...
    timerInterval = setInterval(() => {
        ...
        if (timeLeft <= 0) {
            clearInterval(timerInterval);
            alert(`Time's up! The correct answer was: ${questions[currentQuestionIndex].answers[questions[currentQuestionIndex].correct]}`);
...
function updateTimerDisplay() {
    const timeElement = document.querySelector('.time p:first-child');
